...
process RUN_ARPEGGIO {
    ...
    cache 'lenient'
    conda "${workflow.projectDir}/envs/arpeggio-env.yaml"
...
process PROCESS_ALL_CONTACTS {
    ...
    input:
        ...
        path scop2_domains_description
        path interpro_xml
        path cath_names
        path cddf
        path glycoct_cache
    ...
    output:
        ...
        path("gene3dsa_pdb_residue_interactions.csv.gz"), emit: g3dsa
        path("scop2_fa_pdb_residue_interactions.csv.gz"), emit: scop2b_fa
        path("scop2_sf_pdb_residue_interactions.csv.gz"), emit: scop2b_sf
...
process PRODUCE_NEO4J_FILES {
    ...
    output:
        path "ec_id_nodes.tsv.gz"
        path "ec_nodes_class.tsv.gz"
        path "ec_nodes_subclass.tsv.gz"
        path "ec_nodes_subsubclass.tsv.gz"
        path "ec_class_subclass_rel.tsv.gz"
        path "ec_subclass_subsubclass_rel.tsv.gz"
        path "ec_subsubclass_id_rel.tsv.gz"
        path "cognate_ligand_nodes.tsv.gz"
        path "cognate_ligands_ec.tsv.gz"
        path "pdb_entry_nodes.tsv.gz"
        path "pdb_protein_chain_nodes.tsv.gz"
        path "protein_ec_rels.tsv.gz"
        path "scop_domains_nodes.tsv.gz"
        path "scop2_fa_domains_nodes.tsv.gz"
        path "scop2_sf_domains_nodes.tsv.gz"
        path "scop2_fa_nodes.tsv.gz"
        path "scop2_sf_nodes.tsv.gz"
        path "scop2_cf_nodes.tsv.gz"
        path "scop2_cl_nodes.tsv.gz"
        path "scop2_tp_nodes.tsv.gz"
        path "scop2_sf_fa_rels.tsv.gz"
        path "scop2_sf_cf_rels.tsv.gz"
        path "scop2_cf_cl_rels.tsv.gz"
        path "scop2_cl_tp_rels.tsv.gz"
        path "scop2_fa_domains_rels.tsv.gz"
        path "scop2_sf_domains_rels.tsv.gz"
        path "cath_domains_nodes.tsv.gz"
        path "superfamily_domains_nodes.tsv.gz"
        path "gene3d_domains_nodes.tsv.gz"
        path "pfam_domains_nodes.tsv.gz"
        path "scop_family_nodes.tsv.gz"
        path "scop_superfamily_nodes.tsv.gz"
        path "scop_fold_nodes.tsv.gz"
        path "scop_class_nodes.tsv.gz"
        path "scop_domain_family_rels.tsv.gz"
        path "superfamily_fold_rels.tsv.gz"
        path "scop_family_superfam_rels.tsv.gz"
        path "scop_superfam_fold_rels.tsv.gz"
        path "scop_fold_class_rels.tsv.gz"
        path "cath_class_nodes.tsv.gz"
        path "cath_architecture_nodes.tsv.gz"
        path "cath_topology_nodes.tsv.gz"
        path "cath_homologous_superfamily_nodes.tsv.gz"
        path "cath_class_architecture_rels.tsv.gz"
        path "cath_architecture_topology_rels.tsv.gz"
        path "cath_topology_homology_rels.tsv.gz"
        path "cath_homologous_superfamily_domain_rels.tsv.gz"
        path "cath_topology_domain_rels.tsv.gz"
        path "pfam_clans.tsv.gz"
        path "pfam_clan_rels.tsv.gz"
        path "bound_descriptors.tsv.gz"
        path "be_bd_rels.tsv.gz"
        path "bound_entities.tsv.gz"
        path "be_pdb_rels.tsv.gz"
        path "bound_entity_parity_score_rels.tsv.gz"
        path "cath_domain_ligand_interactions.tsv.gz"
        path "scop_domain_ligand_interactions.tsv.gz"
        path "pfam_domain_ligand_interactions.tsv.gz"
        path "superfamily_domain_ligand_interactions.tsv.gz"
        path "gene3dsa_domain_ligand_interactions.tsv.gz"
        path "scop2_sf_domain_ligand_interactions.tsv.gz"
        path "scop2_fa_domain_ligand_interactions.tsv.gz"
        path "pdb_protein_rels.tsv.gz"
        path "cath_protein_rels.tsv.gz"
        path "scop_protein_rels.tsv.gz"
        path "pfam_protein_rels.tsv.gz"
        path "scop2_fa_protein_rels.tsv.gz"
        path "scop2_sf_protein_rels.tsv.gz"
        path "gene3d_protein_rels.tsv.gz"
        path "superfamily_protein_rels.tsv.gz"
        path "procoggraph_node.tsv.gz"
    script:
    """
    python3 ${workflow.projectDir}/bin/produce_neo4j_files.py --enzyme_dat_file ${enzyme_dat} --enzyme_class_file ${enzyme_class} --cognate_ligands ${cognate_ligands} --cath_domain_ownership ${cath_domain_ownership} --scop_domain_ownership ${scop_domain_ownership} --scop2_sf_domain_ownership ${scop2b_sf_domain_ownership} --scop2_fa_domain_ownership ${scop2b_fa_domain_ownership} --pfam_domain_ownership ${pfam_domain_ownership} --superfamily_domain_ownership ${superfamily_domain_ownership} --gene3dsa_domain_ownership ${g3dsa_domain_ownership} --scop2_domains_info_file ${scop2_domains_info} --scop2_descriptions_file ${scop2_domains_description} --bound_entities ${bound_entities} --parity_calcs ${all_parity_calcs} --parity_threshold ${parity_threshold} --rhea2ec ${rhea2ec} --rhea_dir ${rhea_directions} --rhea_reaction_smiles ${rhea_reaction_smiles}
    """
}
...
workflow {
    ...
    all_contacts = PROCESS_ALL_CONTACTS( contacts.combined_contacts, Channel.fromPath("${params.ccd_cif}"), Channel.fromPath("${params.pfam_a_file}"), Channel.fromPath("${params.pfam_clan_rels}"), Channel.fromPath("${params.pfam_clans}"), Channel.fromPath("${params.scop_domains_info_file}"), Channel.fromPath("${params.scop_descriptions_file}"), Channel.fromPath("${params.scop2_domains_info_file}"), Channel.fromPath("${params.scop2_descriptions_file}"), Channel.fromPath("${params.interpro_xml}"), Channel.fromPath("${params.cath_names}"), Channel.fromPath("${params.cddf}"), Channel.fromPath("${params.glycoct_cache}"), Channel.fromPath("${params.smiles_cache}"), Channel.fromPath("${params.csdb_linear_cache}"), Channel.fromPath("${params.enzyme_dat_file}"), Channel.fromPath("${params.enzyme_class_file}"), Channel.fromPath("${params.sifts_file}") )
