...
def main():
    ...
    gene3dsa_domains_nodes = gene3dsa_domains[["domain_accession", "assembly_chain_id_protein", "xref_db_acc", "gene3d_description", 'domain_type', "derived_from", "interpro_name"]].drop_duplicates()
