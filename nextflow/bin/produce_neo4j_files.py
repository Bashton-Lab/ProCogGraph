...
def main():
    ...
    scop2_sf_cf_rels.rename(columns = {"CF": ":END_ID(scop2-fold-id)", "SF": ":START_ID(scop2-superfam-id)"}, inplace = True)
    scop2_cf_cl_rels = pd.concat([scop2_fa_rels[["CL", "CF"]],scop2_sf_rels[["CL", "CF"]]]).drop_duplicates()
    scop2_cf_cl_rels.rename(columns = {"CL": ":END_ID(scop2-class-id)", "CF": ":START_ID(scop2-fold-id)"}, inplace = True)
    scop2_cl_tp_rels = pd.concat([scop2_fa_rels[["TP", "CL"]],scop2_sf_rels[["TP", "CL"]]]).drop_duplicates()
    scop2_cl_tp_rels.rename(columns = {"TP": ":END_ID(scop2-tp-id)", "CL": ":START_ID(scop2-class-id)"}, inplace = True)

    scop2_fa_nodes.to_csv(f"scop2_fa_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_sf_nodes.to_csv(f"scop2_sf_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_cf_nodes.to_csv(f"scop2_cf_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_cl_nodes.to_csv(f"scop2_cl_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_tp_nodes.to_csv(f"scop2_tp_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_sf_fa_rels.to_csv(f"scop2_sf_fa_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_sf_cf_rels.to_csv(f"scop2_sf_cf_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_cf_cl_rels.to_csv(f"scop2_cf_cl_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_cl_tp_rels.to_csv(f"scop2_cl_tp_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop2_fa_domains_rels.to_csv(f"scop2_fa_domains_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    pfam_domains_nodes.to_csv(f"pfam_domains_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_family_nodes.to_csv(f"scop_family_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_superfamily_nodes.to_csv(f"scop_superfamily_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_fold_nodes.to_csv(f"scop_fold_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_class_nodes.to_csv(f"scop_class_nodes.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_domain_family_rels.to_csv(f"scop_domain_family_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    superfamily_fold_rels.to_csv(f"superfamily_fold_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_family_superfamily_rels.to_csv(f"scop_family_superfam_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_superfamily_fold_rels.to_csv(f"scop_superfam_fold_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_fold_class_rels.to_csv(f"scop_fold_class_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    cath_topology_domain_rels.to_csv(f"cath_topology_domain_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    pfam_clans.to_csv(f"pfam_clans.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    pfam_clan_rels.to_csv(f"pfam_clan_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_domain_ligand_interactions.to_csv(f"scop_domain_ligand_interactions.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    pfam_domain_ligand_interactions.to_csv(f"pfam_domain_ligand_interactions.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    superfamily_domain_ligand_interactions.to_csv(f"superfamily_domain_ligand_interactions.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    gene3dsa_domain_ligand_interactions.to_csv(f"gene3dsa_domain_ligand_interactions.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop2_sf_domain_ligand_interactions.to_csv(f"scop2_sf_domain_ligand_interactions.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop2_fa_domain_ligand_interactions.to_csv(f"scop2_fa_domain_ligand_interactions.tsv.gz", compression = "gzip", sep = "\t", index = False)
    ...
    scop_protein_rels.to_csv(f"scop_protein_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    pfam_protein_rels.to_csv(f"pfam_protein_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_fa_protein_rels.to_csv(f"scop2_fa_protein_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    scop2_sf_protein_rels.to_csv(f"scop2_sf_protein_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    gene3dsa_protein_rels.to_csv(f"gene3d_protein_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
    superfamily_protein_rels.to_csv(f"superfamily_protein_rels.tsv.gz", compression = "gzip", sep = "\t", index = False)
