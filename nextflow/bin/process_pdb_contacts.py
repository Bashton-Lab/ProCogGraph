...
def process_manifest_row(row, cutoff):
    ...
    if os.path.exists(f"{args.pdb_id}_bound_entity_contacts.tsv"):
        ...
        if len(domain_info_df_exploded.loc[domain_info_df_exploded.xref_db == "SCOP2B"]) > 0:
            ...
            domain_info_df_exploded.loc[(domain_info_df_exploded.xref_db == "SCOP2B") & (domain_info_df_exploded.xref_db_acc.str.startswith("SF-DOMID")), "xref_db_acc"] = domain_info_df_exploded.loc[(domain_info_df_exploded.xref_db == "SCOP2B") & (domain_info_df_exploded.xref_db_acc.str.startswith("SF-DOMID")), "xref_db_acc"].str.extract("SF-DOMID:(.*)").astype("int")
            domain_info_df_exploded.loc[(domain_info_df_exploded.xref_db == "SCOP2B") & (domain_info_df_exploded.xref_db_acc.str.startswith("FA-DOMID")), "xref_db_acc"] = domain_info_df_exploded.loc[(domain_info_df_exploded.xref_db == "SCOP2B") & (domain_info_df_exploded.xref_db_acc.str.startswith("FA-DOMID")), "xref_db_acc"].str.extract("FA-DOMID:(.*)").astype("int")
