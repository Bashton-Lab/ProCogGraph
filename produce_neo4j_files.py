...
def main():
    ...
    cath_interface_mapping["allProteinInterface:string[]"] = cath_interface_mapping.allProteinInterface.str.join("|")
    ...
    scop_interface_mapping["allProteinInterface:string[]"] = scop_interface_mapping.allProteinInterface.str.join("|")
    ...
    pfam_domain_ligand_interactions["chainProteinInterface:int[]"] = pfam_domain_ligand_interactions.groupby(["uniqueID"])["pdb_residue_auth_id"].transform(lambda x: get_all_chain_interactions(x))
    ...
    pfam_interface_mapping["allProteinInterface:string[]"] = pfam_interface_mapping.allProteinInterface.str.join("|")
    ...
    interpro_interface_mapping["allProteinInterface:string[]"] = interpro_interface_mapping.allProteinInterface.str.join("|")
