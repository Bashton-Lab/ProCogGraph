...
rule produce_neo4j_files:
    ...
    output:
        ec_id_nodes = outdir + "/ec_id_nodes.csv.gz",
        ec_nodes_class = outdir + "/ec_nodes_class.csv.gz",
        ec_nodes_subclass = outdir + "/ec_nodes_subclass.csv.gz",
        ec_nodes_subsubclass = outdir + "/ec_nodes_subsubclass.csv.gz",
        ec_class_subclass_rel = outdir + "/ec_class_subclass_rel.csv.gz",
        ec_subclass_subsubclass_rel = outdir + "/ec_subclass_subsubclass_rel.csv.gz",
        ec_subsubclass_id_rel = outdir + "/ec_subsubclass_id_rel.csv.gz",
        cognate_ligand_nodes = outdir + "/cognate_ligand_nodes.csv.gz",
        cognate_ligands_ec = outdir + "/cognate_ligands_ec.csv.gz",
        pdb_nodes = outdir + "/pdb_entry_nodes.csv.gz",
        protein_entities = outdir + "/pdb_protein_chain_nodes.csv.gz",
        protein_ec_rels = outdir + "/protein_ec_rels.csv.gz",
        scop_domains_nodes = outdir + "/scop_domains_nodes.csv.gz",
        cath_domains_nodes = outdir + "/cath_domains_nodes.csv.gz",
        interpro_domains_nodes = outdir + "/interpro_domain_nodes.csv.gz",
        pfam_domains_nodes = outdir + "/pfam_domains_nodes.csv.gz",
        scop_family_nodes = outdir + "/scop_family_nodes.csv.gz",
        scop_superfamily_nodes = outdir + "/scop_superfamily_nodes.csv.gz",
        scop_fold_nodes = outdir + "/scop_fold_nodes.csv.gz",
        scop_class_nodes = outdir + "/scop_class_nodes.csv.gz",
        scop_domain_family_rels = outdir + "/scop_domain_family_rels.csv.gz",
        scop_family_superfamily_rels = outdir + "/scop_family_superfam_rels.csv.gz",
        scop_superfamily_fold_rels = outdir + "/scop_superfam_fold_rels.csv.gz",
        scop_fold_class_rels = outdir + "/scop_fold_class_rels.csv.gz",
        cath_class_nodes = outdir + "/cath_class_nodes.csv.gz",
        cath_architecture_nodes = outdir + "/cath_architecture_nodes.csv.gz",
        cath_topology_nodes = outdir + "/cath_topology_nodes.csv.gz",
        cath_homologous_superfamily_nodes = outdir + "/cath_homologous_superfamily_nodes.csv.gz",
        cath_class_architecture_rels = outdir + "/cath_class_architecture_rels.csv.gz",
        cath_architecture_topology_rels = outdir + "/cath_architecture_topology_rels.csv.gz",
        cath_topology_homologous_superfamily_rels = outdir + "/cath_topology_homology_rels.csv.gz",
        cath_homologous_superfamily_domain_rels = outdir + "/cath_homologous_superfamily_domain_rels.csv.gz",
        pfam_clans = outdir + "/pfam_clans.csv.gz",
        pfam_clan_rels = outdir + "/pfam_clan_rels.csv.gz",
        bound_descriptors = outdir + "/bound_descriptors.csv.gz",
        bound_entities_descriptors = outdir + "be_bd_rels.csv.gz",
        be_pdb_rels = outdir + "/be_pdb_rels.csv.gz",
        parity_rels = outdir + "/bound_entity_parity_score_rels.csv.gz",
        cath_domain_ligand_interactions = outdir + "/cath_domain_ligand_interactions.csv.gz",
        scop_domain_ligand_interactions = outdir + "/scop_domain_ligand_interactions.csv.gz",
        pfam_domain_ligand_interactions = outdir + "/pfam_domain_ligand_interactions.csv.gz",
        interpro_domain_ligand_interactions = outdir + "/interpro_domain_ligand_interactions.csv.gz",
        pdb_protein_rels = outdir + "/pdb_protein_rels.csv.gz",
        cath_protein_rels = outdir + "/cath_protein_rels.csv.gz",
        scop_protein_rels = outdir + "/scop_protein_rels.csv.gz",
        pfam_protein_rels = outdir + "/pfam_protein_rels.csv.gz",
        interpro_protein_rels = outdir + "/interpro_protein_rels.csv.gz",
        procoggraph_node = outdir + "/procoggraph_node.csv.gz"
    shell: 
